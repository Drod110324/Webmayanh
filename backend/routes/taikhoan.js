...
router.get('/', async (req, res) => {
  try {
    ...
    const taiKhoans = await TaiKhoan.find(query).select('-password');
    res.json(taiKhoans);
  } catch (error) {
...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const { password: _PASSWORD, ...taiKhoanWithoutPassword } = newTaiKhoan.toObject();
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const { password: _PASSWORD, ...taiKhoanWithoutPassword } = updatedTaiKhoan.toObject();
...
router.post('/login', async (req, res) => {
  try {
    ...
    const { password: _PASSWORD, ...taiKhoanWithoutPassword } = taiKhoan.toObject();
    res.json({
