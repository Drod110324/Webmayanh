          ...
          <OrderDetailContainer>
            <Row gutter={16}>
              <Col span={12}>
                ...
                <p>
                  <strong>Họ tên:</strong> {editingOrder.customerName}
                </p>
                <p>
                ...
                <p>
                  <strong>Địa chỉ giao hàng:</strong> {editingOrder.deliveryAddress}
                </p>
              </Col>
              <Col span={12}>
                ...
                <p>
                  <strong>Ngày đặt:</strong> {new Date(editingOrder.orderDate).toLocaleDateString('vi-VN')}
                </p>
                <p>
                  <strong>Trạng thái:</strong> <Tag color={getStatusColor(editingOrder.status)}>{getStatusText(editingOrder.status)}</Tag>
                </p>
                <p>
                  <strong>Phương thức thanh toán:</strong> {getPaymentMethodText(editingOrder.paymentMethod)}
                </p>
                <p>
                  <strong>Tổng tiền:</strong> <strong style={{ color: '#1890ff' }}>{formatCurrency(editingOrder.totalAmount)}</strong>
                </p>
                {editingOrder.notes && (
                  <p>
